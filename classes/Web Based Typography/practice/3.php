...
<head>
  ...
  <script src="3/cufon-yui.js" type="text/javascript"></script>
  <script src="3/Vollkorn.js" type="text/javascript"></script>

  <script type="text/javascript">
			Cufon.replace('h2', { fontFamily: 'Vollkorn Regular' }); // Works without a selector engine
			Cufon.replace('p', { fontFamily: 'Vollkorn Regular' });
  </script>
...
<!--[if (gt IE 9)|!(IE)]><!--> <body> <!--<![endif]-->
  ...
  <header id="header">
	<div class="container hyphenate">
		<h1>Web Typography for Lawyers (3)</h1>
