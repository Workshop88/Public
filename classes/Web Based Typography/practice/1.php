...
<head>
  ...
  <link rel="stylesheet" href="1sifr/css/sifr.css" type="text/css">
  ...
  <script src="1sifr/js/sifr.js" type="text/javascript"></script>
  <script src="1sifr/js/sifr-config.js" type="text/javascript"></script>
  ...
  <script>
			var calluna = {
			      src: '1sifr/flash/calluna.swf'
			};
			sIFR.activate(calluna);

			sIFR.replace(calluna, {
...
<!--[if (gt IE 9)|!(IE)]><!--> <body> <!--<![endif]-->
  ...
  <header id="header">
	<div class="container hyphenate">
		<h1 class="flash-title">Web Typography for Lawyers (1)</h1>
