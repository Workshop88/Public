...
<head>
  ...
  <script src="4/typeface-0.14.js"></script>
  <script src="4/gentilis_regular.typeface.js"></script>
...
<!--[if (gt IE 9)|!(IE)]><!--> <body> <!--<![endif]-->
  ...
  <header id="header">
	<div class="container hyphenate">
		<h1 id="goog">Web Typography for Lawyers (4)</h1>
		...
		<p class="typeface-js" style="font-family: Gentilis">The slow introduction of a new web standard, CSS3, into a web developer's daily toolkit is driving innovation in the way typography is used on the web.  This is really an exciting time for web designers and font foundries on the internet.  Yet, CSS3, @font-face, and the display of non-system standard typography online is still not an exact science.  How web designers choose to display non-standard fonts on a website largely depends on their knowledge of different web technologies, cross-browser compatibility, and client burden considerations.  That's why the BoingBoing story is important.  Many of the techniques we see being used, like sIFR, or cuf&oacute;n, are largely a product of web designers trying to find the  best way to display fonts on their websites.</p>
