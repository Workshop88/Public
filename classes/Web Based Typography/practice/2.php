...
<head>
  ...
  <script type="text/javascript" src="http://use.typekit.com/gup2jdg.js"></script>
...
<!--[if (gt IE 9)|!(IE)]><!--> <body> <!--<![endif]-->
  ...
  <header id="header">
	<div class="container hyphenate tk-calluna">
		<h1 id="goog">Web Typography for Lawyers (2)</h1>
